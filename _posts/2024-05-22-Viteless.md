...
A browser window should pop up at `localhost:3001` with this hello world app.
...
This is, in a way the natural evolution  to [this post](/_posts/2024-03-03-ESModules-At-Link-Time%20copy.md).
...
The big observation here, is that one can resolve ESModules _directly_ out of ES module syntax in Browser. See this post for more detail. [ES Modules at link time](/_posts/2024-03-03-ESModules-At-Link-Time%20copy.md). This capability is now in SBT, scala-cli and mill.
...
![screencap](/docs/assets/viteless_demo.png)
