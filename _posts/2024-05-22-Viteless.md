...
```
cs launch io.github.quafadas:live-server-scala-cli-js_3:0.0.8 -- --project-dir /Users/simon/Code/viteless --port 3000 --build-tool scala-cli --out-dir /Users/simon/Code/viteless/out --browse-on-open-at /
```
